...
(deftemplate lock-info
  ...
  (slot wasted-time)
  (slot busy-time)
  (slot total-wasted-time)
  (slot total-busy-time)
  (slot tpt)
)
...
(deffacts lock-infos
  (lock-info (name InglisLock) (wasted-time 0) (busy-time 0) (total-wasted-time 0) (total-busy-time 0) (tpt 0))
  (lock-info (name DoshLock) (wasted-time 0) (busy-time 0) (total-wasted-time 0) (total-busy-time 0) (tpt 0))
  (lock-info (name BuckmanLock) (wasted-time 0) (busy-time 0) (total-wasted-time 0) (total-busy-time 0) (tpt 0))
)
